...
- Pipeline, sequencing run, and interactions all significants for the four distance metrics  
- Mothur, dada, and deblur lower mean pairwise distance compared to other pipelines, for all metrics excluding Jaccard, opposite trend. 
- Mothur and qiime Closed ref not significantly different for Unifrac  
- Pipeline seq run results 
    - Mess 
