...
get_map_sub <- function(mgtstMetadata){
...
get_sample_comparisons <- function(map_sub){
    ...
    sample_comparisons[,-which(colnames(sample_comparisons) %in% 
...
get_variation <- function(sample_comparisons) {
...
get_biol_v_tech_variation_comparison_map <- function(sample_comparisons, variation) {
  ...
  biol_v_tech_variation_comparison_map
}
...
get_bio_v_tech_var_comp <- function(mgtstMetadata) {
  ...
  biol_v_tech_variation_comparisons <- rbind(biol_v_tech_variation_comparisons, 
                                             unweighted_unifrac_comp)
  biol_v_tech_variation_comparisons <- rbind(biol_v_tech_variation_comparisons, 
                                             weighted_unifrac_comp)
...
get_varpart_stats <- function(mgtstMetadata){
    # Compute stats
...
ProjectTemplate::cache('biol_v_tech_variation', 
                       {get_bio_v_tech_var_comp(mgtstMetadata)},
