...
Taxonomic classification was performed using the RDP bayesian classifier [@wang2007naive] implented in Mothur.
...
Data from sequencing run NIST1 were used to evaluate normalization method impact on PCR replicate beta-diversity.
...
Signal was measured as the median beta-diversity between samples being compared (Fig. \@ref(fig:experimentalDesign)).
