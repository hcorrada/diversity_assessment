...
Bioinformatic pipelines reduce bias by removin sequencing artifacts, such as single and multi-base pair variants, and chimeric sequences, from microbiome datasets.
...
they should not be used interchangeably but should be evaluated in a complementary manner to gain maximal insight into community differences [@Anderson2011].
