...
For weighted metrics we recommend normalizing counts using TSS and CSS generally improved assessment results or had not effect compared to unnormalized counts.
Rarefying count data generally improved unweighted metric results but higher rarefaction levels tended to perform worse than unnormalized data.
